        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <motion.span
              ...
              className="inline-block px-4 py-1.5 rounded-full text-xs font-semibold uppercase tracking-widest bg-primary/10 text-primary border border-primary/20 mb-6"
            >
              India's #1 Bike Rental Platform
            </motion.span>
            ...
            >
              Rent bikes & scooters starting at just ₹249/day. 
              Flexible packages for daily, weekly & monthly rentals across 6 cities.
            </motion.p>
          </motion.div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full bg-secondary/80 border-none rounded-xl px-4 py-3 text-foreground text-sm focus:ring-2 focus:ring-primary/50 outline-none transition-shadow"
                >
              ...
              <div className="space-y-1.5">
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <button className={cn(
                      "w-full bg-secondary/80 rounded-xl px-4 py-3 text-sm text-left transition-shadow focus:ring-2 focus:ring-primary/50",
              ...
              <div className="flex items-end">
                <Button
                  ...
                  className="w-full py-3 text-sm font-bold gold-shine text-primary-foreground border-0"
                  size="lg"
                >
