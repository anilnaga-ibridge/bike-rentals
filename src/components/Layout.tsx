        ...
        <footer className="border-t border-border pt-14 pb-8 mt-16">
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <a href="mailto:support@sriganeshbikerentals.com" className="text-sm text-muted-foreground flex items-center gap-2 hover:text-primary transition-colors">
                    <Mail className="h-3 w-3 text-primary" /> support@sriganeshbikerentals.com
                  </a>
            ...
            <div className="border-t border-border pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
              <p className="text-xs text-muted-foreground">© 2026 Sri Ganesh Bike Rentals. All rights reserved.</p>
